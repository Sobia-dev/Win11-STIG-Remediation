...
.DESCRIPTION
    ...
    Once the log fills up, the oldest events get overwritten, and during an investigation that can mean the evidence you need is already gone. 
    A bigger log keeps more history.
